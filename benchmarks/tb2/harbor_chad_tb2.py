...
Agent kwargs (--ak key=value):
    ...
    chad_review_pass=true    arm the early-finish self-review (plan 085): a clean finish
                             with >30%% of the wall budget left triggers one fresh-context
                             verification pass. Set false for a clean deadline-only A/B.
...
class ChadAgent(BaseAgent):
    def __init__(
        ...
        *args,
        ...
        chad_review_pass: str | bool = True,
